...
<script>
  import WalletAddress from '../components/WalletAddress.svelte'
  export let title = "";
  export let desc = "";
  export let contact = "";
</script>
